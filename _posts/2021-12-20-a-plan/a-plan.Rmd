...
We soon realised that we had an opportunity to go further with the low-energy side of the project and should aim for a deep retrofit. On the remodelling side of the project, I was pretty uninspired by the first designer I got on board who basically drew what I told him without bringing any creative vision. They also didn't really have the low-energy expertise to support me on the retrofit side.  
...
- Glazing is hopefully optimised to bring light down into the existing house without overheating (the house is East-facing so the sun is on the back all afternoon). 
